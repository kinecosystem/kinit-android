...
class Navigator(private val context: Context) {
    ...
    fun navigateTo(dest: Destination, withSlideAnim: Boolean, reverseAnim: Boolean) {
        when (dest) {
            ...
            Destination.ECO_APPS_COMING_SOON -> navigateToActivity(EcoAppsInfoActivity.getIntent(context, WebInfoViewModel.Type.ECO_APPS_COMING_SOON), withSlideAnim, reverseAnim)
            Destination.ECO_APPS_LEARN_MORE -> navigateToActivity(EcoAppsInfoActivity.getIntent(context,  WebInfoViewModel.Type.ECO_APPS_LEARN_MORE), withSlideAnim, reverseAnim)
        }
    }
