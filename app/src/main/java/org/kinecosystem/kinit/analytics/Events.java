...
public class Events {
    ...
    public static class Analytics {
         ...
         */
        public static class ClickReadButtonOnAppItem implements Event {
            ...
            public ClickReadButtonOnAppItem( String appCategory, String appId, String appName) {
            ...
            @Override
            public String getName() {
                return "click_Read_button_on_App_item";
            }
