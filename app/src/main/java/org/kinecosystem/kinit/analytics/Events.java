...
public class Events {
    ...
    public static class Business {
        ...
        */
        public static class MigrationStarted implements Event {
        ...
        */
        public static class MigrationSucceeded implements Event {
    ...
    public static class BILog {
        ...
        */
        public static class MigrationFailed implements Event {
            
            private String failureReason;
            

            
            public MigrationFailed( String failureReason) {
